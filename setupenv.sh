...
setupenv_openhrp3() {
    if [ $OSNAME = "Darwin" ]; then
      ...
      ## XXX this causes ROS to uninstall
...
setupenv_choreonoid-ros()
{
  ...
  APT_DEPENDENCIES+=(ros-noetic-desktop libfmt-dev)
}
